...
export function Button({ className = '', variant = 'default', size = 'md', disabled, ...rest }: Props) {
  ...
  const enabledVariants: Record<NonNullable<Props['variant']>, string> = {
    default:
      'bg-neutral-800 text-white hover:bg-neutral-700 shadow-sm dark:bg-neutral-200 dark:text-neutral-900 dark:hover:bg-neutral-300',
    ghost:
      'bg-white/70 hover:bg-white/90 border border-neutral-200 text-neutral-800 shadow-sm dark:bg-neutral-900/70 dark:hover:bg-neutral-900/90 dark:border-neutral-700 dark:text-neutral-200',
  ...
  const disabledVariants: Record<NonNullable<Props['variant']>, string> = {
    default:
      'bg-neutral-300 text-white/70 shadow-sm cursor-not-allowed pointer-events-none dark:bg-neutral-700 dark:text-neutral-300/70',
    ghost:
      'bg-white/50 border border-neutral-200 text-neutral-400 shadow-sm cursor-not-allowed pointer-events-none dark:bg-neutral-900/40 dark:border-neutral-700 dark:text-neutral-600',
