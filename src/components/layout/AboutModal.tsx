...
import { AboutModalOpenState, closeAboutModal } from '../../state/AboutModalState'
import { DraggableResizableModal } from '../ui/DraggableResizableModal'
import { GitHubIcon } from '../ui/GitHubIcon'

export function AboutModal() {
  const [open] = useSimpleStore(AboutModalOpenState)
  if (!open) return null
      ...
      <div className="text-[13px] leading-relaxed space-y-4 pr-1 overflow-y-auto max-h-full">
        <div>
          ...
          <p className="text-neutral-600 dark:text-neutral-300 mt-1">
            ...
            community-maintained sources and open schemas (Murmurations, Baserow, and more) and rendered as an
